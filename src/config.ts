...
const CodexLookConfigJsonSchema = Type.Object(
  {
    ...
    scriptPreview: Type.Optional(
      Type.Object(
        ...
        { additionalProperties: false, default: DEFAULT_CODEX_LOOK_CONFIG_JSON.scriptPreview },
      ),
    ),
  },
  { additionalProperties: false },
...
export function parseCodexLookConfig(
  ...
  return {
    ...
    scriptFormatters: parseScriptFormatterCommandsValue(scriptPreview.formatters ?? {}, {
      ...
      ...(options.reportWarning === undefined ? {} : { reportWarning: options.reportWarning }),
    }),
    ...
    patches: {
      assistantSeparator:
        patches.assistantSeparator ?? DEFAULT_CODEX_LOOK_CONFIG_JSON.patches.assistantSeparator,
      workingWidgetSpacing:
        patches.workingWidgetSpacing ?? DEFAULT_CODEX_LOOK_CONFIG_JSON.patches.workingWidgetSpacing,
      autocompleteCleanup:
        patches.autocompleteCleanup ?? DEFAULT_CODEX_LOOK_CONFIG_JSON.patches.autocompleteCleanup,
      markdownSyntax:
