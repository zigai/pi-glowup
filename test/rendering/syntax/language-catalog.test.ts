...
import { BUNDLED_SYNTAX_LANGUAGE_NAMES } from "../../../src/rendering/syntax/bundled-language-names.ts";
import { isBundledSyntaxLanguage } from "../../../src/rendering/syntax/language.ts";
